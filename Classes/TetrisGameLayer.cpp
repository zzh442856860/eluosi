...
void TetrisGameLayer::leftButtonPressed(cocos2d::CCObject *sender){
//    CCLog("left");
    G_current_HandleType->T_playerHandle(LEFTMOVE);
}

void TetrisGameLayer::rightButtonPressed(cocos2d::CCObject *sender){
//    CCLog("right");
    G_current_HandleType->T_playerHandle(RIGHTMOVE);
}

void TetrisGameLayer::downButtonPressed(cocos2d::CCObject *sender){
//    CCLog("down");
